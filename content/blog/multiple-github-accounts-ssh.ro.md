...
Dacă ai mai mult de un cont GitHub — de exemplu unul personal și unul de serviciu — pe același calculator, cheile SSH sunt cea mai curată metodă de a le ține separate. Le configurezi o dată, iar Git alege automat cheia potrivită, în funcție de organizația către care faci push. Acest articol continuă [postarea despre lucrul în echipă](/ro/blog/git-teamwork-and-conflicts); este partea cea mai avansată din serie.
...
## 7. Forțează o anumită cheie pentru o comandă punctuală
