...
If you have more than one GitHub account — say a personal one and a work one — on the same computer, SSH keys are the cleanest way to keep them apart. Set it up once and Git picks the right key automatically, based on which organization you're pushing to. This builds on the [team workflow post](/en/blog/git-teamwork-and-conflicts); it's the most advanced piece of the series.
...
## 7. Force a specific key for a one-off command
